...
<head>
    ...
    <title><?php echo e($user->name); ?> - Resume</title>
            ...
            <div class="sidebar">
                <div class="text-center mb-8">
                    <div class="profile-circle" style="padding: 0; overflow: hidden;">
                        <?php if($user->profile_image): ?>
                            <img src="<?php echo e(asset($user->profile_image)); ?>" alt="<?php echo e($user->name); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                        <?php else: ?>
                ...
                <div class="mb-8">
                    ...
                    <div class="contact-item">
                        ...
                        <span class="break-all"><?php echo e($user->email); ?></span>
                    </div>
                    <?php if($user->address): ?>
                        <div class="contact-item">
                    ...
                    <?php if($user->github): ?>
                        <div class="contact-item">
                            ...
                            <span class="break-all"><?php echo e($user->github); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
                    ...
                    <div>
                        ...
                        <?php $__currentLoopData = $user->skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="skill-item">
                                ...
                                <div class="skill-bar">
                                    <div class="skill-fill" style="width: <?php echo e($skill['level']); ?>%"></div>
                                </div>
                            </div>
            ...
            <div class="main-content md:col-span-2">
                ...
                <?php if($user->about_me): ?>
                    <div class="mb-12">
                        ...
                        <p class="about-text"><?php echo e($user->about_me); ?></p>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="mb-12">
                        ...
                        <?php $__currentLoopData = $user->education; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="education-item">
                                <div class="education-program"><?php echo e($edu['program'] ?? 'Program'); ?></div>
                                <div class="education-school"><?php echo e($edu['school'] ?? 'School'); ?></div>
                                <div class="education-years"><?php echo e($edu['years'] ?? 'Years'); ?></div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php endif; ?>
                        ...
                        <?php $__currentLoopData = $user->projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="project-card">
                                ...
                                <?php if(!empty($project['link'])): ?>
                                    <a href="<?php echo e($project['link']); ?>" target="_blank" class="project-link">
                                        View Project →
                                    </a>
                                <?php endif; ?>
                            </div>
                ...
                <?php if(!$user->about_me && (!$user->education || count($user->education) === 0) && (!$user->projects || count($user->projects) === 0)): ?>
                ...
                <div class="footer-note">
                    ...
                    <p class="mt-2"><?php echo e(date('F d, Y')); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH D:\Resume source code\portfolio-system\resources\views/public/resume.blade.php ENDPATH**/ ?>